...
export default async function Video({ params }: PageProps) {
	...
	const jsonLd = {
        ...
        url: `https://bokepindotoge.pages.dev/v/${file.filecode}`,
        ...
        publisher: {
            '@type': 'Organization',
            name: `${SITENAME}`,
            logo: 'https://bokepindotoge.pages.dev/favicon.ico'},
            author: {
                '@type': 'Person',
                name: 'admin',
                url: 'https://bokepindotoge.pages.dev'
              }
        }
        const jsonLd2 = {
        '@context': 'https://schema.org',
